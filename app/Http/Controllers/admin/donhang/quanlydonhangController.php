...
class quanlydonhangController extends Controller
{
    public function quanlydonhang()
    {
        ...
        $khohang = DB::table('khohang')
            ...
            ->get();
        return view('admin.donhang.quanlydonhang', compact('thongtinshop', 'donhang', 'donhang2', 'donhang3', 'chitietdonhang', 'khohang'));
    }
    ...
    public function banle(Request $request)
    {
        $id = Auth::user()->id;
        $khohang = DB::table('khohang')
        ...
        $donhang['diachigiaohang'] = 'Ban le';
        $donhang['thanhtiendonhang'] = $request->giaban * $request->soluongsanpham;
        $donhang['trangthaidonhang'] = 3;
