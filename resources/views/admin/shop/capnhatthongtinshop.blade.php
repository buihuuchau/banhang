                    ...
                    <div class="card-body">
                        <form action="{{ route('capnhat2thongtinshop')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required="true" type="email" class="form-control" name="emailshop" placeholder="abc@gmail.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="{{ old('emailshop') }}">
                            </div>

                            <div class="form-group">
                                <label>WEBSITE SHOP:</label>
                                <input required="true" type="url" class="form-control" name="websiteshop" pattern="https?://.+" placeholder="http:// or https://" value="{{ old('websiteshop') }}">
                            </div>

                            <div class="form-group">
                                <label>VỊ TRÍ SHOP:</label>
                                <input required="true" type="text" class="form-control" name="vitrishop" value="{{ old('vitrishop') }}">
                            </div>
